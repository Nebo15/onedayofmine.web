...
CREATE TABLE `day` (
  ...
  `finish_comment_id` int(11) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `day_comment_like`
--
...
--
-- Table structure for table `day_finish_comment`
--

DROP TABLE IF EXISTS `day_finish_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `moment_comment_like`
--
...
CREATE TABLE `user` (
  ...
  `image_ext` enum('jpg','jpeg','png','gif') DEFAULT NULL,
  `facebook_uid` char(20) NOT NULL,
  `facebook_access_token` char(255) NOT NULL,
  `facebook_profile_utime` int(10) unsigned NOT NULL,
...
INSERT INTO `schema_info` (`version`) VALUES (1346499977);
