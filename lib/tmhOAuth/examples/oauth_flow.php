...
$tmhOAuth = new tmhOAuth(array(
  'consumer_key'    => lmbToolkit::instance()->getConf('twitter')->get('twitter_consumer_key'),
  'consumer_secret' => lmbToolkit::instance()->getConf('twitter')->get('twitter_consumer_secret')
));
